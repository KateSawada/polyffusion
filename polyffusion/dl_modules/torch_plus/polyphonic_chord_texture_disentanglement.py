from polyffusion.dl_modules.torch_plus.module import PytorchModel
from polyffusion.dl_modules.torch_plus.train_utils import get_zs_from_dists, kl_with_normal
import torch
from torch import nn
from torch.distributions import Normal
import numpy as np
from polyffusion.dl_modules.chord_enc import RnnEncoder
from polyffusion.dl_modules.chord_dec import ChordDecoder
from polyffusion.dl_modules.txt_enc import TextureEncoder
from polyffusion.dl_modules.pianotree_dec import PianoTreeDecoder
...
class DisentangleVAE(PytorchModel):
    ...
    def init_model(device=None, chd_size=256, txt_size=256, num_channel=10):
        ...
        # pt_decoder = PianoTreeDecoder(note_embedding=None,
